...
public class OrderService {
    ...
    public OrderResponseDTO create(OrderRequestDTO dto) {
        ...
        try {
            ...
            System.out.println(saved.getProductId());
            System.out.println(saved.getQuantity());
            ...
            OrderResponseDTO responseDTO = mapper.toResponseDTO(saved);

            System.out.println(responseDTO.getId());
            System.out.println(responseDTO.getProductId());
